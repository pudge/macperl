...
resource 'DITL' (SaveAlert) {
	{	{ 74, 303,  94, 362}, Button		{ enabled, "Save"},
		...
		{ 74,  65,  94, 150}, Button		{ enabled, "DonÕt Save"},
		{ 10,  65,  59, 363}, StaticText	{disabled, "Save changes to Ò^0Ó?"},
...
resource 'DITL' (RevertAlert) {
	{	{ 74, 303,  94, 362}, Button		{ enabled, "Revert"},
		{ 74, 231,  94, 290}, Button		{ enabled, "Cancel"},
		{ 10,  65,  59, 363}, StaticText	{disabled, "Revert to the last saved version of Ò^0Ó?"},
		{ 10,  20,  42,  52}, Icon			{disabled, 2},
...
resource 'DITL' (HelperAlert) {
	{	{106, 193, 126, 362}, Button		{ enabled, "Launch Internet Config"},
		...
		{ 10,  65,  91, 363}, StaticText	{disabled,
			"Could not find helper for Ò^0Ó. Do you want to create one?\n"
			"For ÒhttpÓ, you should specify a WWW browser as the helper, "
			"for ÒpodÓ, you should specify ÒShuckÓ."
										},
		{ 10,  20,  42,  52}, Icon			{disabled, 2},
...
resource 'DITL' (PrefLibID, "", purgeable) {
	{	{ 80,  30, 195, 425}, UserItem		{disabled },
		...
		{275, 260, 295, 400}, Button		{ enabled, "Add PathÉ"},
...
resource 'DITL' (PrefEnvID, "", purgeable) {
	{	{ 60,  10, 270, 425}, UserItem		{disabled },
		...
		{275, 260, 295, 400}, Button		{ enabled, "Add VariableÉ"}
	}
};
...
resource 'DITL' (PrefEnvAddID, "", purgeable) {
	{	{145, 275, 165, 345}, Button		{ enabled, "OK"},
		...
		{ 55, 190,  75, 265}, Button		{ enabled, "FileÉ"},
		{ 55, 275,  75, 345}, Button		{ enabled, "FolderÉ"},
...
resource 'DLOG' (1005, "printingÉ", purgeable) {
	{148, 157, 185, 354},
	dBoxProc,
	visible,
	noGoAway,
...
resource 'DITL' (1005, "printingÉ", purgeable) {
...
resource 'DITL' (NoPerlAlert) {
	{	{114, 323, 134, 402}, Button		{ enabled, "Proceed"},
		...
		{ 10,  65,  99, 403}, StaticText	{disabled,
			"I'm not sure Ò^0Ó is really a Perl script (the #! line is missing). "
...
resource 'MENU' (appleID) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"About MacPerlÉ", noIcon, noKey, noMark, plain,
		/* [2] */
...
resource 'MENU' (fileID) {
	...
	{	"New",			noIcon, "N",	noMark, plain,
		...
		"Save AsÉ",		noIcon, "S",	noMark, extend,
...
resource 'MENU' (editID) {
	...
	{	"Undo",			noIcon, "Z",	noMark, plain,
		...
		"Jump toÉ",		noIcon, "J",	noMark, plain,
		"-",			noIcon, noKey,	noMark, plain,
		"FormatÉ",		noIcon, "Y",	noMark, plain,
		"-",			noIcon, noKey,	noMark, plain,
...
resource 'MENU' (perlID, preload) {
	...
	enabled,
	"Script",
	{	"Run ScriptÉ",			noIcon, "R",	noMark, plain,
		"Run Front Window",		noIcon, "R",	noMark, extend,
		"Syntax CheckÉ",		noIcon, "K",	noMark, plain,
...
resource 'MENU' (editorID) {
	...
	enabled,
	"Editor",
	{	"EditÉ",				noIcon, "E",	noMark,  plain,
		"Edit Front Window",	noIcon, "E",	noMark, extend,
		"-",					noIcon, noKey,	noMark, plain,
		"UpdateÉ",				noIcon, "U",	noMark, plain,

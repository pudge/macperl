...
Text::ParseWords::Old - parse text into an array of tokens

=head1 SYNOPSIS

  use Text::ParseWords::Old;
...
B<NOTE>: This is an old version of L<Text::ParseWords>, provided only
because the new version, on some very long lines of text, will hit a
stack overflow.  This older version doesn't have that problem.  Only
use this version if the current version crashes.  This module is not
supplied with any other version of perl, so do not count on it for
